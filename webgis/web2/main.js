...
function saveCookie () {
    ...
    SetCookie ("inputZeroAzimuth", document.getElementById("inputZeroAzimuth").value, expdate, null, null, false);
}
...
// Atmospheric Refraction correction
    ...
    if ((output) && (solarZen > 108.0) ) {
        ...
        document.getElementById("azbox").value = (Math.floor(azimuth*100 +0.5) - (document.getElementById("inputZeroAzimuth").value*100))/100.0;
...
function clearOutputs()
{
    ...
    document.getElementById("inputZeroAzimuth").value = "0"
}
